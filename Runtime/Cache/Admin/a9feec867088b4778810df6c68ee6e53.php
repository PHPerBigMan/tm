                    ...
                    <div class="am-panel-bd">
                        <div class="am-form-group">
                            ...
                            <select id="doc-select-1" name="status">
                                <option value="0" <?php if(($_GET['status']) == "0"): ?>selected<?php endif; ?>>全部</option>
                                <option value="10" <?php if(($_GET['status']) == "10"): ?>selected<?php endif; ?>>待付款</option>
                                <option value="20" <?php if(($_GET['status']) == "20"): ?>selected<?php endif; ?>>待发货</option>
                                <option value="30" <?php if(($_GET['status']) == "30"): ?>selected<?php endif; ?>>待收货</option>
                                <option value="50" <?php if(($_GET['status']) == "50"): ?>selected<?php endif; ?>>已完成</option>
                            </select>
                        </div>
                        <div class="am-form-group">
        ...
        methods: {
            ...
            cancle_order:function (id,event,aid) {
                layer.confirm('确定要取消该订单吗？', {
                    ...
                    $.get('/admin/Order/cancelorder',{id:id},function (data) {
                        $temp = $.parseJSON(data);
                        if($temp['status'] == "200"){
            ...
            change_price:function (id,event,aid) {
                layer.prompt({
                    ...
                    $.get('/admin/Order/changeorder',{id:id,money:pass},function (data) {
                        console.log(aid)
                        $temp = $.parseJSON(data);
                        if($temp['status'] == "200"){
            ...
            fahuo:function (id) {
                layer_show('订单发货','/admin/Order/fahuo/?id='+id,500,390)
            }
        }
    })
