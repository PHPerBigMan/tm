...
<div class="am-cf admin-main2">
    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <?php if($_GET['hw']!= 2 ): ?><div class="am-cf am-padding am-padding-bottom-0 am-animation-slide-top hw-nav" >
            ...
            <?php if($_GET['hw']!= 2 ): ?><div class="am-alert am-alert-secondary am-animation-scale-up" style="margin: 0px 20px;">
                <form class="am-form" action="/Admin/user/lists" method="get"  id="from1">
                    ...
                    <select name="type" class="form-control" style="width: 120px;display: inline-block;height: 35px;font-size: 14px">
                        <option value="1" <?php if(($_GET['type']) == "1"): ?>selected<?php endif; ?>>搜昵称</option>
                        <option value="2" <?php if(($_GET['type']) == "2"): ?>selected<?php endif; ?>>搜ID</option>
                    </select>
...
<script>
    ...
    methods: {
        edit: function (id) {
            layer_full("查看用户详情",'/admin/User/edit/?id='+id)
        },
        jilu: function (id) {
        ...
        fenxiao:function (id) {
            layer_full("查看分销关系",'/admin/User/fenxiao/?id='+id)
        },
        shanchu: function (id,key) {
            layer.msg('确定要删除吗？', {
                ...
                btn: ['确定', '取消'],
                yes: function(){
                    $.get('/admin/User/del/?id='+id+"&type=1",function (data) {
                        $temp = $.parseJSON(data);
                        if($temp['status'] == "200"){
        ...
        huifu: function (id,key) {
            layer.msg('确定要恢复帐号吗？', {
                ...
                btn: ['确定', '取消'],
                yes: function(){
                    $.get('/admin/User/del/?id='+id+"&type=2",function (data) {
                        $temp = $.parseJSON(data);
                        if($temp['status'] == "200"){
