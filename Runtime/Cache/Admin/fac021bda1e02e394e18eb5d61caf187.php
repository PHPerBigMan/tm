    ...
    <form class="am-form am-form-horizontal" action="" method="post" id="from1">
        <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4">
                <input type="text" class="am-input-sm" name="title" placeholder="" value="<?php echo ($admin["title"]); ?>">
            </div>
        ...
        <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="hidden" name="gid" value="<?php echo ($admin["gid"]); ?>">
                <input type="hidden" class="input-text" value="{{rule_val}}" name="rule">
                <input type="text" class="am-input-sm" name="miaoshu" placeholder="请输入简短描述" value="<?php echo ($admin["miaoshu"]); ?>">
            </div>
        </div>
        ...
        <div class="am-g am-margin-top-sm">
            <div class="am-u-sm-8 am-u-sm-offset-2">
                <?php if($admin["gid"] == '' ): ?><button type="button" class="am-btn am-btn-primary">添加用户组</button>
                    <?php else: ?>
                    <button type="button" class="am-btn am-btn-primary">添加用户组</button><?php endif; ?>
            </div>
        </div>
    </form>
...
<script>
    var vm = new Vue({
        ...
        data: {
            ...
            cat:<?php echo ($cat); ?>,
            rule_val:[],
            current:<?php echo ((isset($admin) && ($admin !== ""))?($admin):[]); ?>,
        },
        computed: {
            rule_val: function () {
