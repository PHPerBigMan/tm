...
<head>
    ...
    <style>
        ...
        .active span.up{background: url("<?php echo C('CDN_PATH');?>/Public/resource/images/icon_tri_shang.png?<?php echo C('CDN_VERSION');?>");display: inline-block;width: 6px;height: 4px;background-size: cover;margin-left: 3px}
        .active span.down{background: url("<?php echo C('CDN_PATH');?>/Public/resource/images/icon_tri_xia.png?<?php echo C('CDN_VERSION');?>");display: inline-block;width: 6px;height: 4px;background-size: cover;margin-left: 3px}
                    ...
                    <template v-for="(mykey,item) in data">
                        <li>
                            <a href="/Home/goods/detail/?id={{item.commodityid}}">
                                <img src="<?php echo C('CDN_PATH');?>/Public/resource/hw/images/grey.gif" v-lazyload:opt.fadein="item.thumbnail">
                                <p>{{ item.title }}</p>
