    ...
    <div class="page">
        ...
        <div class="content infinite-scroll infinite-scroll-bottom">
            ...
            <div style="text-align: center;height: 100%;background: #fff" v-else>
                <img src="<?php echo C('CDN_PATH');?>/Public/resource/hw/images/image_dpj.png?<?php echo C('CDN_VERSION');?>" width="140" style="margin-top: 50px;">
...
<script>
    ...
    var page = 2;
    function addItems() {
        $.post('/Home/goods/comment?id=<?php echo $_GET['id'];?>&page='+page,function (data) {
            console.log(data)
            if(data == "0"){
    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            detail: function (event) {
                window.location.href = '/Home/goods/detail/?id=<?php echo $_GET['id'];?>'
            },
