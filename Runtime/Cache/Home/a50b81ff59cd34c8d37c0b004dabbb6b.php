...
<head>
    ...
    <link rel="stylesheet" href="/Public/resource/dist/vux.css">
    ...
    <script src="https://vux.li/gitfile/dist/components/group/index.js?v0.1.1"></script>
    <script src="https://vux.li/gitfile/dist/components/x-textarea/index.js?v0.1.1"></script>
</head>
<body>
    ...
    <div class="page">
        <div class="content">
            ...
            <div class="content-block hw-list">
                <ul><input type="hidden" name="id" value="<?php echo $_GET['id'];?>">
    ...
    var vm = new Vue({
        ...
        methods: {
            tijiao: function (id,key,event) {
                ...
                $.post('/Home/Order/evaluate_handle',$("#pingjia").serialize(),function(data){
                    $temp = $.parseJSON(data)
                    if($temp['status'] == "200"){
